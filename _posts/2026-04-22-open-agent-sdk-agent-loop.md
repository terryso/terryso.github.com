...
> 本文是「深入 Open Agent SDK (Swift)」系列第一篇。[系列目录见这里](/2026/04/18/open-agent-sdk-swift.html)。
...
- **第 0 篇**：[Open Agent SDK (Swift)：用原生 Swift 并发构建 AI Agent 应用](/2026/04/18/open-agent-sdk-swift.html)
